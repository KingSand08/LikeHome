...
const BookingsPage = () => {
  ...
  return (
    <div className="p-8">
      ...
      >
        {reservations.filter((reservation) => !reservation.is_cancelled) .map((reservation) => {
          ...
          return (
            ...
            >
              ...
              <p className="text-md font-semibold mt-2 ">
                Check-in:{" "}
                <span className="text-info ">{reservation.checkin_date}</span>
              </p>
              <p className="text-md font-semibold mb-4">
                Check-out:{" "}
                <span className="text-info ">{reservation.checkout_date}</span>
              </p>
