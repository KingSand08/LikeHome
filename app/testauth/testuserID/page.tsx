      ...
      <div className="h-screen flex items-center justify-center">
        <div className="bg-white flex rounded-lg w-3/4">
          <div className="flex-1 text-gray-800 p-20">
            ...
            <pre className="mt-12 text-2xl text-purple-600 italic">
            ...
            >
              <button className="m-10 text-center border border-transparent rounded-md shadow-sm px-4 py-2 bg-blue-600 text-white font-medium hover:bg-blue-800 transition duration-200 ease-in-out focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2 w-1/2">
                Sign Out
              </button>
            </form>
            <div>
