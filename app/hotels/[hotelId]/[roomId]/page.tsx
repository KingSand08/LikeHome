      ...
      <div className="p-6 bg-gray-100 rounded-lg shadow-lg mb-8">
        ...
        {loading ? (
          ...
          <div className="text-center">
            ...
            <div className="text-lg font-medium text-blue-700 mb-6">
          ...
          <p className="text-center text-gray-500">No hotel room data found</p>
        )}
      </div>
        ...
        <ul className="space-y-3 text-center">
          {Object.entries(bookingDetails).map(([key, value]) => (
            <li key={key} className="text-md text-gray-700">
              <strong className="text-gray-900">{key.replace("_", " ")}</strong>
