...
const SigninPage = (props: Props) => {
    return (
        <div className="flex flex-col lg:flex-row items-center justify-center opacity-100 px-4 dark:text-gray-100">
            {/* Wrapper */}
            <div className="flex flex-col min-[900px]:flex-row rounded-lg overflow-hidden w-full min-[900px]:max-w-5xl max-w-md">
                {/* Left Section */}
                <div className="flex-1 p-0 md:p-10">
                    <h1 className="text-2xl max-[900px]:text-[1.22em] md:text-3xl pb-4">Let&apos;s get started!</h1>
                    <p className="text-base max-[900px]:text-[0.9em] md:text-lg opacity-90">
                ...
                {/* Right (Image) Section */}
                <div className="relative flex max-[900px]:hidden items-center justify-center p-4 lg:p-6">
                    <Image
                        alt="likehome image"
                        ...
                        height={1000}
                        quality={100}
                        className="rounded-lg w-full min-[800px]:w-[15em] min-[1300px]:w-[30em] lg:w-[20em] object-cover"
                    />
                </div>
            </div>
        </div>
